...
public class DeliveryStatus extends javax.swing.JPanel {
    ...
    GroceryOrderDirectory orderDirectory;
    EcoSystem ecosystem;
    DeliveryMan deliveryMan;
    Customer cust;
    HotelOrderDirectory hotelDirectory;
    UserAccount userAccount;
    /**
     * Creates new form DeliveryStatus
     */
    public DeliveryStatus(JPanel userProcessContainer, EcoSystem ecosystem, GroceryOrderDirectory orderDirectory, HotelOrderDirectory hotelDirectory, DeliveryMan deliveryMan, UserAccount userAccount) {
        initComponents();
    ...
    private void initComponents() {
        ...
        SubmitButton.setBackground(new java.awt.Color(127, 195, 126));
    ...
    private void SubmitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SubmitButtonActionPerformed
        ...
        if (statusCombo.getSelectedIndex() >= 0) {
            ...
            if(orderDirectory != null) {
                ...
                System.out.println("before grocery" + deliveryMan.getGroceryOrderList().size());
            }else{
             hotelDirectory.setStatus(item);   
             System.out.println("before hotel" + deliveryMan.getHotelOrderLists().size());
            }
