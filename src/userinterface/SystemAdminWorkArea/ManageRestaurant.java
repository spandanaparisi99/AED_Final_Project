...
//    EcoSystem ecosystem;
     ...
     */
    public ManageRestaurant(JPanel userProcessContainer1, EcoSystem system) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("View Restaurant");
        ...
        restaurantList.setForeground(new java.awt.Color(51, 51, 51));
    ...
    private void addRestButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addRestButtonActionPerformed
        ...
        if(managerListCombo.getSelectedItem() == null || managerListCombo.getSelectedIndex() == 0) {
            JOptionPane.showMessageDialog(null,"Select a value from dropdown of Restaurants to update","Error message", JOptionPane.ERROR_MESSAGE);
            return;
