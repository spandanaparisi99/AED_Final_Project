 ...
 * @author raaga
 */
public class RestaurantMain extends javax.swing.JPanel {
    ...
    public RestaurantMain(JPanel userProcessContainer1, EcoSystem system) {
    ...
    private void ManageGroceryButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ManageGroceryButtonActionPerformed
        ManageRestaurant rest= new ManageRestaurant(userProcessContainer, ecosystem);
    ...
    private void manageGroceryManagersButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_manageGroceryManagersButtonActionPerformed
        ...
        ManagerRestaurantManagers restM= new ManagerRestaurantManagers(userProcessContainer, ecosystem);
