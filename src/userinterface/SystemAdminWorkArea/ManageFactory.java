...
import Business.Role.GovOfficialRole;
 ...
 * @author raaga
 */
public class ManageFactory extends javax.swing.JPanel {
...
//    EcoSystem ecosystem;
     ...
     */
    public ManageFactory(JPanel userProcessContainer1, EcoSystem system) {
        initComponents();
    ...
    public void viewHotelList() {
        if (ecosystem.getFactoryDirectory().getFactoryList().size() > 0) {
            for (int i = 0; i < ecosystem.getFactoryDirectory().getFactoryList().size(); i++) {
                model.addRow(new Object[]{
                    ...
                    ecosystem.getFactoryDirectory().getFactoryList().get(i).getManagerDetails().getName(),
                    ...
                    ecosystem.getFactoryDirectory().getFactoryList().get(i).getNetwork()
                });
            }
        }
    }
    ...
    public void showDeleteList() {
        for (int i = 0; i < ecosystem.getFactoryDirectory().getFactoryList().size(); i++) {
            restListCombo.addItem(ecosystem.getFactoryDirectory().getFactoryList().get(i).getName());
            updateRestListCombo.addItem(ecosystem.getFactoryDirectory().getFactoryList().get(i).getName());

        }
    }

    public void showComboBoxesList() {
        for (int i = 0; i < ecosystem.getFactoryManagerDirectory().getFactoryManagerList().size(); i++) {
            managerListCombo.addItem(ecosystem.getFactoryManagerDirectory().getFactoryManagerList().get(i).getName());
            updateManagerListCombo.addItem(ecosystem.getFactoryManagerDirectory().getFactoryManagerList().get(i).getName());
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Add a Factory Outlet");
        ...
        addRestButton.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        ...
        jLabel2.setText("Delete a Factory");
        ...
        jLabel4.setText("View Factory");

        deleteRestButton.setBackground(new java.awt.Color(127, 195, 126));
        deleteRestButton.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        ...
        jLabel5.setText("Update Factory Details");
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/busubusu8-cute.gif"))); // NOI18N
    ...
    private void deleteRestButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteRestButtonActionPerformed
        ...
        if(restListCombo.getSelectedItem() == null || restListCombo.getSelectedIndex() == 0) {
            JOptionPane.showMessageDialog(null,"Select a value from dropdown of Factory to delete","Error message", JOptionPane.ERROR_MESSAGE);
            return;
        }
        if (flag == false) {
            Boolean isDelete = ecosystem.getFactoryDirectory().deleteFactory(selectedItem);
    ...
    public FactoryManager getCurrent(String name) {
        for (int i = 0; i < ecosystem.getFactoryManagerDirectory().getFactoryManagerList().size(); i++) {
            if (ecosystem.getFactoryManagerDirectory().getFactoryManagerList().get(i).getName().equals(name)) {
                return ecosystem.getFactoryManagerDirectory().getFactoryManagerList().get(i);
            }
        }
        return null;
    }
    ...
    private void addRestButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addRestButtonActionPerformed
        ...
        if(managerListCombo.getSelectedItem() == null || managerListCombo.getSelectedIndex() == 0) {
            JOptionPane.showMessageDialog(null,"Select a manager to assign","Error message", JOptionPane.ERROR_MESSAGE);
            return;
        } else if (!validateFields(locationText.getText(), phoneText.getText(), restNameText.getText())) {
            return;
        }
        for (int i = 0; i < ecosystem.getFactoryDirectory().getFactoryList().size(); i++) {
            if(ecosystem.getFactoryDirectory().getFactoryList().get(i).getName() == null ? restNameText.getText() == null : ecosystem.getFactoryDirectory().getFactoryList().get(i).getName().equals(restNameText.getText())){
                JOptionPane.showMessageDialog(null,"Factory Already Present", "Error message" ,JOptionPane.ERROR_MESSAGE);
                return;
            }
        }
        String managerSelectedItem = (String) managerListCombo.getSelectedItem();
        String selectedItem = (String) restListCombo.getSelectedItem();
        FactoryManager rm = getCurrent(managerSelectedItem);
        ecosystem.getFactoryDirectory().createFactory(restNameText.getText(), rm, phoneText.getText(), locationText.getText(), rm.getNetwork());
        System.out.println("Hotel added ....");
        JOptionPane.showMessageDialog(this, "Factory added successfully");
    ...
    private void btnBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackActionPerformed
        FactoryMain dm= new FactoryMain(userProcessContainer, ecosystem);
    ...
    private void updateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBtnActionPerformed
        ...
        if(updateRestListCombo.getSelectedItem() == null || updateRestListCombo.getSelectedIndex() == 0) {
            JOptionPane.showMessageDialog(null,"Select a value from dropdown of Factories to update","Error message", JOptionPane.ERROR_MESSAGE);
            return;
        ...
        if(updateManagerListCombo.getSelectedItem() == null || updateManagerListCombo.getSelectedIndex() == 0) {
            JOptionPane.showMessageDialog(null,"Select a value from manager dropdown of Factory to update","Error message", JOptionPane.ERROR_MESSAGE);
            return;
        }
        if (flag == false) {
//            Boolean isDelete = ecosystem.getRestaurantDirectory().deleteRestaurant(selectedItem);
            for (int i = 0; i < ecosystem.getFactoryDirectory().getFactoryList().size(); i++) {
                if (ecosystem.getFactoryDirectory().getFactoryList().get(i).getName().equals(selectedItem)) {
                    ecosystem.getFactoryDirectory().getFactoryList().get(i).setName(updateRestNameText.getText());
                    ecosystem.getFactoryDirectory().getFactoryList().get(i).setLocation(updateLocationText.getText());
                    ecosystem.getFactoryDirectory().getFactoryList().get(i).setPhone(updatePhoneText.getText());
                    ecosystem.getFactoryDirectory().getFactoryList().get(i).setManagerDetails(rm);
                }
            }
        }
    ...
    private void updateRestListComboActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateRestListComboActionPerformed
        ...
        if (updateRestListCombo.getSelectedItem() != "None") {
            String selectedItem = (String) updateRestListCombo.getSelectedItem();
            for (int i = 0; i < ecosystem.getFactoryDirectory().getFactoryList().size(); i++) {
                if (ecosystem.getFactoryDirectory().getFactoryList().get(i).getName().equalsIgnoreCase(selectedItem)) {
                    updateRestNameText.setText(ecosystem.getFactoryDirectory().getFactoryList().get(i).getName());
                    updateLocationText.setText(ecosystem.getFactoryDirectory().getFactoryList().get(i).getLocation());
                    updatePhoneText.setText(ecosystem.getFactoryDirectory().getFactoryList().get(i).getPhone());
                    updateManagerListCombo.setSelectedItem(ecosystem.getFactoryDirectory().getFactoryList().get(i).getManager());
                    break;
                }
            }
        }else{
