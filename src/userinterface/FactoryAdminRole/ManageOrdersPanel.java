...
public class ManageOrdersPanel extends javax.swing.JPanel {
    ...
    private FactoryOrderDirectory selectedDir;

    /**
     * Creates new form ManageOrders
     */
    public ManageOrdersPanel(JPanel userProcessContainer, EcoSystem system, Factory fac, UserAccount ua) {
        initComponents();
    ...
    public void viewOrderDirList() {
        ...
        for (int i = 0; i < factory.getOrderDirectoryList().size(); i++) {
            for (int j = 0; j < factory.getOrderDirectoryList().get(i).getOrderList().size(); j++) {
                name = factory.getOrderDirectoryList().get(i).getCustomerDetails().getUsername();
            }
            ordersModel.addRow(new Object[]{
                i+1,
                factory.getOrderDirectoryList().get(i).getStatus(),
                name,
                factory.getOrderDirectoryList().get(i).getComment(),
                factory.getOrderDirectoryList().get(i).getFeedbackComment()
            });
        }
    }
    ...
    private void initComponents() {
        ...
        orderTable.setBackground(new java.awt.Color(254, 254, 226));
        ...
        acceptBtn.setBackground(new java.awt.Color(127, 195, 126));
        acceptBtn.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        ...
        rejectBtn.setBackground(new java.awt.Color(127, 195, 126));
        rejectBtn.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        ...
        assignLabel.setForeground(new java.awt.Color(254, 254, 226));
        ...
        finishBtn.setBackground(new java.awt.Color(127, 195, 126));
        finishBtn.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(6, 6, 6)
                        .addComponent(acceptBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 131, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(256, 256, 256))
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(title, javax.swing.GroupLayout.DEFAULT_SIZE, 552, Short.MAX_VALUE)
                        .addGap(129, 129, 129))))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(title, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 58, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addComponent(acceptBtn, javax.swing.GroupLayout.DEFAULT_SIZE, 35, Short.MAX_VALUE)))
                .addGap(79, 79, 79)
                .addComponent(jLabel3)
                .addGap(114, 114, 114))
        );
    ...
    private void rejectBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rejectBtnActionPerformed
       if (selectedDir != null) {
            ...
            for (int i = 0; i < factory.getOrderDirectoryList().size(); i++) {
                if (factory.getOrderDirectoryList().get(i).getId() == (selectedDir.getId())) {
                    factory.getOrderDirectoryList().remove(i);
        ...
        if (assignCombo.getSelectedItem() != null && selectedDir != null) {
            ...
            for (int i = 0; i < ecosystem.getDeliveryManDirectory().getDeliverymanList().size(); i++) {
                if (ecosystem.getDeliveryManDirectory().getDeliverymanList().get(i).getName().equalsIgnoreCase(selectedItem)) {
                    ...
                    ecosystem.getDeliveryManDirectory().getDeliverymanList().get(i).getFactoryOrderList().add(selectedDir);
    ...
    private void orderListTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_orderListTableMouseClicked
        ...
        selectedDir = factory.getOrderDirectoryList().get(orderListTable.getSelectedRow());
        ArrayList<FactoryOrder> orderlist = factory.getOrderDirectoryList().get(orderListTable.getSelectedRow()).getOrderList();
        for (int i = 0; i < orderlist.size(); i++) {
            model.addRow(new Object[]{
                ...
                selectedDir.getFactory().getName()
            });
        }
