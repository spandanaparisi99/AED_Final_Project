 ...
 * @author RAJAS
 */
public class ManageFactoryInventoryPanel extends javax.swing.JPanel {
     ...
     */
    public ManageFactoryInventoryPanel(JPanel userProcessContainer, EcoSystem system, Factory fac, UserAccount ua) {
        initComponents();
        ecosystem = system;
        ...
        System.out.println(factory.getMenu());
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/factory_1.gif"))); // NOI18N
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        factory.setMenu(menu);
        System.out.println(menu.size() + "jsdje " + factory.getMenu().size());
        reset();
        // TODO add your handling code here:
