...
public class ManageOrdersPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        acceptBtn.setFont(new java.awt.Font("Times New Roman", 1, 13)); // NOI18N
        ...
        rejectBtn.setFont(new java.awt.Font("Times New Roman", 1, 13)); // NOI18N
        ...
        finishBtn.setFont(new java.awt.Font("Times New Roman", 1, 13)); // NOI18N
        ...
        Backbutton.setFont(new java.awt.Font("Times New Roman", 1, 13)); // NOI18N
        ...
        if (assignCombo.getSelectedItem() != null && selectedDirs != null) {
            ...
            for (int i = 0; i < ecosystem.getDeliveryManDirectory().getDeliverymanList().size(); i++) {
                if (ecosystem.getDeliveryManDirectory().getDeliverymanList().get(i).getName().equalsIgnoreCase(selectedItem)) {
                    ...
                    ecosystem.getDeliveryManDirectory().getDeliverymanList().get(i).getHotelOrderLists().add(selectedDirs);
