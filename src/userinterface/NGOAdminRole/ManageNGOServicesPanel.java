...
public class ManageNGOServicesPanel extends javax.swing.JPanel {
    ...
    public ManageNGOServicesPanel(JPanel userProcessContainer, EcoSystem system, NGO leg,  UserAccount ua) {
        initComponents();
...
//        }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        ngo.setMenu(menu);
        System.out.println(menu.size() + "jsdje " + ngo.getMenu().size());
        reset();
        // TODO add your handling code here:
